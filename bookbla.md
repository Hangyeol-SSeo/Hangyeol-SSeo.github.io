...
<div style="display: flex; gap: 20px; margin: 20px 0;">
  <div style="flex: 1; background: #f8f9fa; padding: 20px; border-radius: 8px;">
    <h3 style="margin-top: 0;">📚 서재 등록</h3>
    <p style="color: #666;">자신의 가치관을 표현하는 책을 등록하고 감상문 작성</p>
  </div>
  <div style="flex: 1; background: #f8f9fa; padding: 20px; border-radius: 8px;">
    <h3 style="margin-top: 0;">💌 엽서 매칭</h3>
    <p style="color: #666;">관심 있는 상대에게 엽서를 보내 매칭 요청</p>
  </div>
  <div style="flex: 1; background: #f8f9fa; padding: 20px; border-radius: 8px;">
    <h3 style="margin-top: 0;">💬 채팅</h3>
    <p style="color: #666;">매칭된 상대와 1:1 채팅 및 모임 채팅방을 통해 소통</p>
  </div>
</div>
...
<div class="growth-card" style="background: #f5f5f5; padding: 30px; border-radius: 12px; margin: 20px 0; font-size: medium">
  ...
  <b>아키텍처 제안 이유</b>: Paid media를 사용하지 않는 중이었고, 현재 예측 사용량이 많지 않아서 비용 효율적이라고 생각. 또한 나중에 확장에도 쉽기에 서버리스 아키텍처를 시도 <br/>
